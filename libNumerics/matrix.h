/* Matrix and vector classes.
    ...
    Copyright (C) 2013 Victoria Rudakova <vicrucann@gmail.com>
...
/// vectorRef class: reference on existing vector or its part
template <typename T>
class vectorRef : public vector<T>
{
public:
	vectorRef(int size, T* ptr) 
	{ 
		this->m_rows =  size; 
		this->m_cols = 1; 
		this->p = ptr; 
...
/// Input vector. Need to know the dimensions in advance...
template <class T>
inline std::istream& operator>>(std::istream& in,
